...
Last Modified Date : 2024-08-20 01:09
...
from src.utils import log_history
from src.config_and_variables import APP_INSTRUCTION, ENDPOINT
...
def main():
    ...
    gr.ChatInterface(
        ...
        theme="soft",
        examples=["Hello, who are you?", "arxiv:2311.11100", "file:files/HowtoReadPaper.pdf", "delete:2311.11100.pdf", "Summarize the paper within 100 words."],
